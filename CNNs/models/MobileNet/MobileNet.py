...
class MobileNetV2_CNN (CNN.CNN):
    def __init__(self,dropout=0.25, num_classes=2,data_shape=(224,224,3)):
        CNN.CNN.__init__(self,"EfficientNetB0",'.\CNNs\models\MobileNet\checkpoints',dropout=dropout,
                     num_classes=num_classes,data_shape=data_shape)
        
    
    def createModel(self):
        #create efficientNetB0 layers
        efficientNet=tf.keras.applications.mobilenet_v2.MobileNetV2(
